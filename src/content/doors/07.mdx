...
<Section title="Why It Matters" meta="IMPACT">
  ...
  <List>
    ...
    <Item>
      <b>Disclosure of Filtering Criteria.</b> Security prompts reveal exactly what content filters exist: "Never discuss explosives, hacking, or violence." <Link href="https://arxiv.org/html/2405.06823v2">Research shows attackers use this knowledge</Link> to craft prompts that evade detection by avoiding flagged keywords.
    </Item>
    <Item>
...
<Section title="Interactive Simulation" meta="LAB" noPadding>
  <div className="px-6 pt-6 pb-4">
    <p className="text-sm text-neutral-300 mb-2">
      See how system prompts can be extracted using various techniques. This simulation demonstrates how different attack methods – from direct requests to encoding tricks – succeed or fail against models with varying levels of protection.
    </p>
  </div>
...
<Section title="Further Reading" meta="RESOURCES">
  ...
  <List>
    <Item>
      <Link href="https://x.com/elder_plinius/status/1801446659498455296">SYSTEM PROMPT LEAK</Link> – Pliny the prompter, real-world system prompt leak examples.
    </Item>
    <Item>
    ...
    <Item>
      <Link href="https://x.com/Green_Terminals/status/1839141215685996906">OpenAI Advanced Voice Mode System Prompt</Link> – Green_Terminals, leaked OpenAI advanced voice mode instructions.
    </Item>
  </List>
  ...
  <List>
    <Item>
      <Link href="https://atlas.mitre.org/techniques/AML.T0051.000">MITRE ATLAS AML.T0051.000 - LLM Prompt Injection: Direct</Link> – Meta Prompt Extraction technique classification.
    </Item>
  </List>
</Section>
