...
<Section title="Attack Techniques" meta="ATTACK VECTORS">
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: Low difficulty—package name verification and lockfiles prevent this.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: Medium—requires proper registry configuration and namespace protection.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: High difficulty—updates appear to come from trusted sources.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: Medium—tools like Picklescan can detect known patterns, but obfuscation is possible.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: High difficulty—behavioral changes may only manifest on specific inputs.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: High difficulty—model appears to come from trusted source.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: High difficulty—poisoned samples may be statistically indistinguishable from legitimate data.</span>
    </Item>
  </List>
...
<Section title="Real-World Incidents" meta="CASE STUDIES">
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack surface: Software dependencies. Impact: System data exfiltration at scale.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack surface: Build pipeline. Impact: Widespread corporate and government network compromise.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack surface: Model artifacts. Impact: Demonstrated feasibility of backdoored model distribution.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack surface: Model artifacts (pickle). Impact: Potential RCE on developer/production machines.</span>
    </Item>
  </List>
