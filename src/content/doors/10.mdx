...
<Section title="TL;DR" meta="AT A GLANCE">
  <div className="space-y-4">
    ...
    <p>
      Model DoS exploits the 1000× cost multiplier of LLM inference versus traditional web services. Sponge attacks – benign-looking prompts that trigger 10-200× resource consumption – bypass traditional defenses and can escalate costs from $3/hour to $3,000/hour.
    </p>
  </div>
</Section>
...
<Section title="The Three Attack Surfaces" meta="FUNDAMENTALS">
  <p>
    Model DoS attacks exploit three interconnected layers of LLM systems. Based on patterns described in <Link href="https://genai.owasp.org/llmrisk/llm102025-unbounded-consumption/">OWASP LLM10:2025</Link> and related research, we can categorize these attack surfaces as follows:
  </p>
  <Steps>
    <Step n={1}>
...
<Section title="Builder's Security Checklist" meta="IMPLEMENTATION">
  ...
  <List>
    ...
    <Item>
      <b>Output Length Limits.</b> Do you enforce maximum output token counts (e.g., 4k tokens)? Are streaming responses capped?
    </Item>
    <Item>
  ...
  <List>
    ...
    <Item>
      <b>Access Controls Configured.</b> Is RBAC implemented? Do API keys have appropriate permission scopes and expiration policies?
    </Item>
  </List>
  <p>
    The following demonstration illustrates realistic Model DoS scenarios and how defense mechanisms respond.
  </p>
</Section>
...
<Section title="Interactive Simulation" meta="LAB" noPadding>
  <div className="px-6 pt-6 pb-4">
    <p className="text-sm text-neutral-300 mb-2">
      This demonstration shows Model DoS attack patterns - how they affect resource consumption, latency, and cost, and how rate limiting, timeouts, and sponge detection defenses respond to each threat.
    </p>
  </div>
...
<Section title="Key Takeaways" meta="SUMMARY">
  <List>
    ...
    <Item>
      <b>Sponge Attacks Bypass Traditional Defenses.</b> Benign-looking prompts that trigger 10-200× resource use evade WAFs and content filters. Defense requires semantic understanding and predictive models.
    </Item>
    <Item>
...
<Section title="Further Reading" meta="RESOURCES">
  ...
  <List>
    <Item>
      <Link href="https://www.lasso.security/blog/denial-of-service-dos-and-denial-of-wallet-dow-attacks">GenAI Under Attack: DoS & Denial of Wallet Threats</Link> – Lasso Security, comprehensive overview of DoS and DoW attacks on GenAI systems.
    </Item>
    <Item>
      <Link href="https://aws.amazon.com/blogs/security/context-window-overflow-breaking-the-barrier/">Context Window Overflow: Breaking the Barrier</Link> – AWS Security Blog, context window exhaustion attacks and mitigations.
    </Item>
    <Item>
      <Link href="https://www.infoq.com/news/2025/08/denial-of-wallet-attack-cloud/">When Unchecked Autoscaling Generates a $120K Cloud Spend</Link> – InfoQ, real-world case study of denial-of-wallet attack causing $120K cloud bill.
    </Item>
    <Item>
      <Link href="https://sourcegraph.com/blog/security-update-august-2023">Sourcegraph Security Incident – API Rate Limit Abuse via Credential Leak</Link> – Sourcegraph, real-world API abuse incident (August 2023).
    </Item>
  </List>
  ...
  <List>
    <Item>
      <Link href="https://www.sciencedirect.com/science/article/pii/S0020025525000374">Energy-Latency Attacks via Sponge Poisoning</Link> – ScienceDirect, training-time attacks to increase energy consumption and prediction latency (2025).
    </Item>
    <Item>
      <Link href="https://arxiv.org/abs/2508.19284">A Comprehensive Review of Denial of Wallet Attacks in Serverless Architectures</Link> – arXiv, categorization of DoW attack types including Blast DDoW, Continual Inconspicuous DDoW, and Background Chained DDoW.
    </Item>
    <Item>
      <Link href="https://arxiv.org/abs/2402.06357">The SkipSponge Attack: Sponge Weight Poisoning of Deep Neural Networks</Link> – arXiv, novel sponge attack technique targeting model weights to increase inference costs.
    </Item>
    <Item>
  ...
  <List>
    <Item>
      <Link href="https://cwe.mitre.org/data/definitions/770.html">MITRE CWE-770 - Allocation of Resources Without Limits or Throttling</Link> – CWE parent category for unbounded resource allocation vulnerabilities.
    </Item>
    <Item>
      <Link href="https://platform.openai.com/docs/guides/rate-limits">OpenAI API Rate Limits</Link> – Official documentation on rate limiting to prevent API abuse and resource exhaustion.
    </Item>
    <Item>
    ...
    <Item>
      <Link href="https://krishnag.ceo/blog/denial-of-wallet-dow-attacks-on-cloud-based-ai-models-a-financial-timebomb-for-c-suite-leaders/">Denial of Wallet Attacks on Cloud-Based AI Models</Link> – Executive perspective on DoW attacks targeting AI chatbots and API endpoints.
    </Item>
    <Item>
    ...
    <Item>
      <Link href="https://salt.security/blog/api4-2023-unrestricted-resource-consumption">API4:2023 Unrestricted Resource Consumption</Link> – Salt Security, in-depth analysis of OWASP API4 vulnerability and attack vectors.
    </Item>
    <Item>
