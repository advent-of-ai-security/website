...
description: Memorized training data, system prompts, and verbose errors can leak confidential artifacts.
date: 2025-12-04
meta:
  - Door 02
  - OWASP - LLM02:2025
...
<Section title="What You Will Learn" meta="OBJECTIVES">
  ...
  <List>
    ...
    <Item>
      <b>Identify</b> attack techniques including verbatim/approximate memorization, membership inference attacks, prompt extraction, and RAG document exfiltration.
    </Item>
    <Item>
...
<Section title="What Is Information Disclosure?" meta="DEFINITION">
  ...
  <p>
    It's not just training data. If your application crashes and the LLM prints a Python stack trace to the user, you might be revealing file paths, library versions, or even database connection strings.
  </p>
...
<Section title="The Three Disclosure Vectors" meta="FUNDAMENTALS">
  ...
  <p>
    The attack techniques we'll explore are methods to exploit these three vectors, ranging from simple prompt manipulation to sophisticated statistical inference.
  </p>
</Section>

<Section title="Attack Vectors by Layer" meta="ATTACK VECTORS">
  <p>
    Research <Link href="https://www.ijcai.org/proceedings/2025/1156.pdf">systematically surveys PII leakage attacks</Link>, covering jailbreak techniques, extraction methods, and training data memorization. We organize these attacks by the layer they target.
  </p>
  ...
  <List>
    <Item>
      <b>Verbatim vs. Approximate Memorization.</b> Researchers <Link href="https://arxiv.org/abs/2410.02650">distinguish memorization by severity</Link>: <i>verbatim memorization</i> (exact recall of training data, like SSNs or email addresses) and <i>approximate memorization</i> (high-similarity reproduction without exact duplication). Both pose privacy risks – verbatim leakage is more obvious, but approximate leakage is harder to detect and mitigate.
      <p className="text-xs text-neutral-500 mt-1">Detection difficulty: High for approximate, Medium for verbatim.</p>
    </Item>
    <Item>
...
<Section title="Real-World Incidents" meta="CASE STUDIES">
  ...
  <List>
    <Item>
      <b>Training Data Extraction Research.</b> Researchers <Link href="https://arxiv.org/abs/2311.17035">extracted gigabytes of training data</Link> (including PII) from production models using divergence attacks. The technique proved surprisingly effective at recovering memorized content from models like GPT-Neo, LLaMA, and ChatGPT.
  ...
  <List>
    <Item>
      <b>Samsung Source Code Leak.</b> <Link href="https://www.techradar.com/news/samsung-workers-leaked-company-secrets-by-using-chatgpt">Employees pasted proprietary semiconductor code</Link> into ChatGPT to get debugging help, accidentally uploading trade secrets to OpenAI's servers. Samsung subsequently banned employee use of generative AI tools.
  ...
  <List>
    <Item>
      <b>ChatGPT "Guessing Game" Exploit.</b> <Link href="https://futurism.com/clever-jailbreak-chatgpt-windows-activation-keys">Users tricked ChatGPT into revealing Windows activation keys</Link> by framing the interaction as a playful guessing game. The phrase "I give up" acted as a trigger, compelling the AI to reveal keys that were likely memorized from public forums in its training data.
      <p className="text-xs text-neutral-500 mt-1">Attack type: Jailbreak. Impact: Licensed product keys exposed.</p>
    </Item>
  </List>
...
<Section title="Builder's Security Checklist" meta="IMPLEMENTATION">
  ...
  <List>
    ...
    <Item>
      <b>System Prompt Review.</b> Does your system prompt contain credentials, API keys, or internal URLs? Remove them. Use environment variables and external secret management instead.
    </Item>
  </List>
  ...
  <p className="mt-4">
    The following demonstration illustrates how information disclosure attacks work and how defenses respond.
  </p>
</Section>
...
<Section title="Interactive Simulation" meta="LAB" noPadding>
  <div className="px-6 pt-6 pb-4">
    <p className="text-sm text-neutral-300 mb-2">
      This demonstration shows how information disclosure attacks work in practice - how models can leak training data, system prompts, and backend information, and which defenses effectively block these attempts.
    </p>
  </div>
...
<Section title="Further Reading" meta="RESOURCES">
  ...
  <List>
    ...
    <Item>
      <Link href="https://arxiv.org/abs/2012.07805">Extracting Training Data from Large Language Models</Link> – Carlini et al., foundational paper on training data extraction attacks (2020).
    </Item>
  </List>
  ...
  <List>
    ...
    <Item>
      <Link href="https://arxiv.org/abs/2410.02650">Undesirable Memorization in Large Language Models: A Survey</Link> – Categorizes verbatim vs approximate memorization and analyzes mitigation strategies (October 2024).
    </Item>
    <Item>
  ...
  <List>
    ...
    <Item>
      <Link href="https://www.foxbusiness.com/politics/ai-data-leak-crisis-prevent-company-secrets-chatgpt">AI Data Leak Crisis: New Tool Prevents Company Secrets from Being Fed to ChatGPT</Link> – Fox Business coverage of LLM Shield prevention tooling.
    </Item>
    <Item>
      <Link href="https://not-just-memorization.github.io/extracting-training-data-from-chatgpt.html">Extracting Training Data from ChatGPT</Link> – Research page documenting the famous "repeat poem forever" divergence attack that extracted training data.
    </Item>
    <Item>
      <Link href="https://www.nist.gov/blogs/cybersecurity-insights/how-deploy-machine-learning-differential-privacy">How to Deploy Machine Learning with Differential Privacy</Link> – NIST Cybersecurity Insights, practical differential privacy implementation guide covering DP-SGD and PATE.
    </Item>
    <Item>
      <Link href="https://avidml.org/database/avid-2023-v009/">AVID-2023-V009: Proof Pudding (CVE-2019-20634)</Link> – Adversarial evasion attack vulnerability demonstration.
    </Item>
    <Item>
      <Link href="https://github.com/moohax/Proof-Pudding">Proof Pudding Research</Link> – Will Pearce & Nick Landers, model extraction and adversarial evasion research from DerbyCon 2019.
    </Item>
    <Item>
