...
<Section title="Real-World Incidents" meta="CASE STUDIES">
  ...
  <List>
    <Item>
      <b>Training Data Extraction Research.</b> Researchers extracted several megabytes of training data (including PII) from production models using divergence attacks. The technique proved surprisingly effective at recovering memorized content from models like GPT-Neo, LLaMA, and ChatGPT. <Link href="https://arxiv.org/abs/2311.17035">arXiv: Scalable Extraction</Link>
