...
<Section title="Why It Matters" meta="IMPACT">
  ...
  <List>
    <Item>
      <b>Denial-of-Wallet (DoW): Formalized Threat.</b> <Link href="https://genai.owasp.org/llmrisk/llm102025-unbounded-consumption/">OWASP LLM10:2025</Link> now formally recognizes DoW as a primary attack vector where adversaries exploit consumption-based pricing to drain financial resources. If you pay per token, attackers can automate thousands of long-context requests to run up costs. <Link href="https://medium.com/enkrypt-ai/defending-against-sponge-attacks-in-genai-applications-be22605794a7">Sponge attack research</Link> shows malicious inputs increase energy consumption and latency by <b>10-200×</b>, with costs potentially escalating from $3/hour to $3,000/hour.
    </Item>
    <Item>
    ...
    <Item>
      <b>Cascading Failures.</b> <Link href="https://aclanthology.org/2025.findings-acl.580.pdf">Crabs research (2025)</Link> demonstrates a single optimized prompt can increase latency <b>250×</b>, causing timeout cascades across dependent services (chatbots, RAG systems, agent workflows).
    </Item>
    <Item>
