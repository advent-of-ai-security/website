...
<Section title="Attack Techniques" meta="ATTACK VECTORS">
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: High difficulty—poisoned samples are statistically indistinguishable from legitimate data.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: High difficulty—requires crawler-specific auditing infrastructure.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      <b>RLHF Manipulation.</b> Crowdworkers or compromised labelers mark dangerous content as "safe/helpful" or inject trigger-response pairs into instruction datasets. <Link href="https://arxiv.org/abs/2408.02946">AAAI 2025 research</Link> showed larger models (72B parameters) learn harmful behaviors from poisoned fine-tuning data 4× faster than smaller models.
      <br/><span className="text-xs text-neutral-500">Detection: Medium—canary examples and labeler auditing can catch inconsistencies.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: High difficulty—base model passes all safety evaluations.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection: Medium—content integrity monitoring and access controls can mitigate.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      <b>Model Hub Poisoning.</b> <Link href="https://blog.mithrilsecurity.io/poisongpt-how-we-hid-a-lobotomized-llm-on-hugging-face-to-spread-fake-news/">PoisonGPT (2023)</Link> demonstrated uploading backdoored models to Hugging Face that spread misinformation while passing benchmarks. Malicious pickling can also execute arbitrary code during model loading.
      <br/><span className="text-xs text-neutral-500">Detection: Medium—cryptographic verification and safetensors format prevent code execution.</span>
    </Item>
    <Item>
      <b>Adversarial Data Manipulation (Nightshade).</b> <Link href="https://nightshade.cs.uchicago.edu/whatis.html">UChicago research</Link> allows artists to add imperceptible perturbations to images, causing models trained on them to misclassify objects (dogs → cats, cars → cows), degrading model quality as a form of copyright protest.
      <br/><span className="text-xs text-neutral-500">Detection: High difficulty—perturbations are imperceptible to humans.</span>
    </Item>
  </List>
...
<Section title="Real-World Incidents" meta="CASE STUDIES">
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Vector: Pre-training data. Impact: Demonstrated practical feasibility of web crawl poisoning.</span>
    </Item>
    <Item>
      <b>Sleeper Agents (2024).</b> <Link href="https://arxiv.org/html/2401.05566v3">Anthropic research</Link> trained models with persistent backdoors that behave normally until triggered. Models wrote secure code for 2023 prompts but inserted exploitable code for 2024 prompts. Standard safety training failed to remove these behaviors and sometimes enhanced concealment.
      <br/><span className="text-xs text-neutral-500">Vector: Fine-tuning data. Impact: Proved backdoors survive safety training.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Vector: Real-time fine-tuning. Impact: Reputational damage, product shutdown.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Vector: Model checkpoint. Impact: Demonstrated supply chain vulnerability at scale.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Vector: Training images. Impact: Copyright protection through adversarial data.</span>
    </Item>
  </List>
...
<Section title="Defense Strategy Tiers" meta="SECURITY CONTROLS">
  ...
  <Steps>
    <Step n={6}>
      ...
      <p className="text-sm mt-2">After training, test the model with <Link href="https://huggingface.co/papers/2408.12798">BackdoorLLM benchmark</Link> (200+ experiments across 8 attack types). Systematically probe for backdoors using automated trigger search techniques. Monitor for performance regression on safety benchmarks.</p>
    </Step>
    <Step n={7}>
...
<Section title="Interactive Simulation" meta="LAB" noPadding>
  <div className="px-6 pt-6 pb-4">
    <p className="text-sm text-neutral-300 mb-2">
      Use this simulation to explore how training data poisoning works. See how malicious samples can embed backdoors, how triggers activate hidden behaviors, and experiment with detection strategies to understand the challenges of identifying poisoned data.
    </p>
  </div>
