...
<Section title="What Is Information Disclosure?" meta="DEFINITION">
  ...
  <p>
    The consequences of information disclosure extend far beyond embarrassment—they can destroy businesses, violate regulations, and erode user trust permanently.
  </p>
</Section>
...
<Section title="Attack Vectors by Layer" meta="ATTACK VECTORS">
  <p>
    <Link href="https://www.ijcai.org/proceedings/2025/1156.pdf">IJCAI 2025 survey</Link> categorizes PII leakage into two primary research areas: jailbreak techniques to bypass security and training data leakage through memorization. We organize these attacks by the layer they target.
  </p>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection difficulty: High for semantic, Medium for verbatim.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection difficulty: High—statistical analysis required.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection difficulty: Medium—requires specialized prompting.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection difficulty: Low—well-known patterns can be filtered.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Detection difficulty: Medium—requires access control at retrieval.</span>
    </Item>
  </List>
...
<Section title="Real-World Incidents" meta="CASE STUDIES">
  ...
  <List>
    <Item>
      <b>Google DeepMind Extraction.</b> Researchers extracted several megabytes of training data (including PII) from production models using simple "repeat this word" attacks. The divergence attack technique proved surprisingly effective at recovering memorized content. <Link href="https://arxiv.org/abs/2311.17035">arXiv: Compressible Data</Link>
      <br/><span className="text-xs text-neutral-500">Attack type: Training data extraction. Impact: PII and copyrighted content exposed.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack type: Unintentional disclosure. Impact: Trade secret exposure to third party.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack type: Social engineering/jailbreak. Impact: Licensed product keys exposed.</span>
    </Item>
  </List>
...
<Section title="Interactive Simulation" meta="LAB" noPadding>
  <div className="px-6 pt-6 pb-4">
    <p className="text-sm text-neutral-300 mb-2">
      Use this simulation to explore how information disclosure attacks work in practice. Try different extraction techniques to see how models can leak training data, system prompts, and backend information—then test defensive prompts to understand what works and what doesn't.
    </p>
  </div>
...
<Section title="Further Reading" meta="RESOURCES">
  ...
  <p className="text-xs font-bold uppercase tracking-wider text-neutral-500 mt-6 mb-3">Tools & Practical Guides</p>
  <List>
    <Item>
    ...
    <Item>
      <Link href="https://github.com/anthropics/anthropic-cookbook/tree/main/capabilities/classification">Anthropic Classification Cookbook</Link> — Techniques for building output filters and PII detectors.
    </Item>
  </List>
</Section>