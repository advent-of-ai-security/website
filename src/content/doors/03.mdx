...
<TLDR>
  <div className="space-y-4">
    <Quote minimal source="OWASP LLM03" href="https://genai.owasp.org/llmrisk/llm03-training-data-poisoning/">
      Poisoning occurs when an attacker manipulates the training data or fine-tuning process of an LLM to introduce vulnerabilities, biases, or backdoors that compromise the model’s security, effectiveness, or ethical behavior.
    </Quote>
    <List>
