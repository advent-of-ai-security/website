...
<Section title="Attack Sophistication Ladder" meta="ATTACK VECTORS">
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Skill required: Social engineering and prompt crafting.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Skill required: Understanding of conversational priming and model psychology.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Skill required: Understanding of in-context learning and long context exploitation.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Skill required: Image manipulation, steganography, or adversarial ML techniques.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Skill required: Understanding of function calling, APIs, and agent architectures.</span>
    </Item>
  </List>

  <p className="mt-4">
    These case studies that follow demonstrate how these techniques translate from research papers to real-world breaches.
  </p>
</Section>
...
<Section title="Real-World Incidents" meta="CASE STUDIES">
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack type: Direct injection. Impact: Intellectual property exposure.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack type: Direct injection. Impact: Operational logic exposure.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack type: Indirect injection. Impact: Conversation data leaked.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack type: Indirect injection (email). Impact: Internal file exfiltration.</span>
    </Item>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack type: Indirect injection (code repository). Impact: Source code theft.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack type: Self-replicating indirect injection. Impact: Autonomous malware propagation.</span>
    </Item>
  </List>
  ...
  <List>
    <Item>
      ...
      <br/><span className="text-xs text-neutral-500">Attack type: Tool-use exploitation. Impact: PII exfiltration via API calls.</span>
    </Item>
  </List>
...
<Section title="Further Reading" meta="RESOURCES">
  ...
  <List>
    ...
    <Item>
      <Link href="https://arxiv.org/abs/2302.12173">Compromising Real-World LLM Applications with Indirect Prompt Injection</Link> — Greshake et al., the foundational paper that defined the field (2023).
    </Item>
  </List>
