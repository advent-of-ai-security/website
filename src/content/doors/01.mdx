...
<Section title="Interactive Simulation" meta="LAB" noPadding>
  <div className="px-6 pt-6 pb-4">
    <p className="text-sm text-neutral-300 mb-2">
      Select attack scenarios and toggle security gates to see how defenses block or fail to block different patterns. Compare direct injection, indirect injection, and legitimate requests to understand why architectural controls matter.
    </p>
  </div>
