...
<Section title="TL;DR" meta="AT A GLANCE">
  <div className="space-y-4">
    <Quote minimal source="OWASP LLM03:2025 Supply Chain Vulnerabilities" href="https://genai.owasp.org/llmrisk/llm032025-supply-chain/">
      Supply Chain Vulnerabilities arise when an application relies on compromised third-party models, libraries, or datasets.
    </Quote>
    <p>
...
<Section title="Why It Matters" meta="IMPACT">
  ...
  <List>
    ...
    <Item><b>Hidden Backdoors.</b> A compromised foundation model might behave normally 99% of the time but <Link href="https://arxiv.org/abs/2204.06974">contain undetectable backdoors that alter outputs for attacker-chosen inputs</Link>. Imagine a sentiment analysis model that works perfectly except when analyzing your competitor's products.</Item>
...
<Section title="Attack Techniques" meta="ATTACK VECTORS">
  ...
  <List>
    ...
    <Item>
      <b>Dependency Confusion.</b> <Link href="https://medium.com/@alex.birsan/dependency-confusion-4a5d60fec610">Original research on dependency confusion</Link> showed attackers publish malicious packages with the same name as internal private packages to public registries. When your build system resolves dependencies, it may pull the attacker's public version instead of your internal one.
  ...
  <List>
    <Item>
      ...
      <p className="text-xs text-neutral-500 mt-1">Detection: Medium to High – tools like Picklescan exist but have known bypass vulnerabilities; sophisticated payloads can evade detection.</p>
    </Item>
    <Item>
      <b>LoRA/Adapter Poisoning.</b> Lightweight fine-tuning adapters (LoRA, QLoRA, PEFT) are small files that modify model behavior. <Link href="https://arxiv.org/abs/2403.00108">Research shows backdoor LoRAs can be merged with legitimate task-enhancing adapters</Link>, concealing malicious intent behind improved capabilities – a malicious adapter can subtly alter outputs without triggering obvious red flags.
...
<Section title="Real-World Incidents" meta="CASE STUDIES">
  ...
  <List>
    ...
    <Item>
      <b>SolarWinds Orion (2020).</b> While not AI-specific, <Link href="https://www.cisa.gov/news-events/alerts/2021/01/07/supply-chain-compromise">this attack demonstrated the devastating potential of supply chain compromise</Link>. Attackers infiltrated the build pipeline, distributing backdoored updates to 18,000+ organizations including US government agencies. The same techniques apply to ML pipelines.
  ...
  <List>
    <Item>
      <b>PoisonGPT Demonstration.</b> Mithril Security researchers demonstrated how easy it is to upload a "lobotomized" LLM to Hugging Face – a model that appears normal but spreads targeted misinformation. They modified GPT-J-6B to give false answers about specific topics while performing correctly on benchmarks. <Link href="https://blog.mithrilsecurity.io/poisongpt-how-we-hid-a-lobotomized-llm-on-hugging-face-to-spread-fake-news/">Mithril Security</Link>
    ...
    <Item>
      <b>Malicious Pickle Models on Hugging Face.</b> <Link href="https://jfrog.com/blog/data-scientists-targeted-by-malicious-hugging-face-ml-models-with-silent-backdoor/">Security researchers discovered hundreds of models on Hugging Face</Link> containing malicious pickle payloads capable of arbitrary code execution. These models could steal credentials, install backdoors, or exfiltrate data from anyone who loaded them.
...
<Section title="Builder's Security Checklist" meta="IMPLEMENTATION">
  ...
  <p className="mt-4">
    The following demonstration illustrates supply chain attack scenarios and the warning signs that indicate compromise.
  </p>
</Section>
...
<Section title="Interactive Simulation" meta="LAB" noPadding>
  <div className="px-6 pt-6 pb-4">
    <p className="text-sm text-neutral-300 mb-2">
      This demonstration shows how malicious packages and model files can compromise environments, highlighting the warning signs that indicate supply chain attacks.
    </p>
  </div>
...
<Section title="Further Reading" meta="RESOURCES">
  ...
  <List>
    <Item>
      <Link href="https://hiddenlayer.com/innovation-hub/silent-sabotage/">Hijacking Safetensors Conversion on Hugging Face</Link> – HiddenLayer research on safetensors conversion attacks.
    </Item>
    <Item>
    ...
    <Item>
      <Link href="https://arxiv.org/abs/2311.05553">Removing RLHF Protections in GPT-4 via Fine-Tuning</Link> – Research demonstrating safety removal through fine-tuning.
    </Item>
    <Item>
    ...
    <Item>
      <Link href="https://huggingface.co/spaces/safetensors/safetensors-checker">Safetensors Checker</Link> – Official Hugging Face tool to check safetensors metadata.
    </Item>
    <Item>
  ...
  <List>
    ...
    <Item>
      <Link href="https://github.com/pyupio/safety">safety</Link> – Python dependency scanner for known security vulnerabilities.
    </Item>
    <Item>
      <Link href="https://github.com/dependabot">GitHub Dependabot</Link> – Automated dependency updates and security alerts.
    </Item>
  </List>
</Section>